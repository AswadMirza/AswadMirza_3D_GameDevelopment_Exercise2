...
//Code taken from the textbook "Unity 2018 Cookbook - Third Edition" - Chapter 2 Excersice 11
public class Radar : MonoBehaviour
{
    ...
    //A bit unnecessary but i am making ti so that I can drag a reference of the player object in
